...
namespace MatchRedux
{
	...
	public class ReduxViewModel
	{
		...
		public ReduxItem ReduxItem { get; set; }
		public PipsProgramme Programme { get; set; }
		public ReduxToPips ReduxToProgramme { get; set; }
		...
		public string ServiceName
		{
			get
			{
				return Services[ReduxItem.service_id].Name;
			}
		}
		...
		public string ProgrammesUrl
		{
			get
			{
				return Services.ProgrammesUrl(ReduxItem.service_id, ReduxItem.aired);
			}
		}
		...
		public string ProgrammesUrlHtml
		{
			get
			{
				return Services.ProgrammesUrlHtml(ReduxItem.service_id, ReduxItem.aired);
			}
		}
		...
		public string ProgrammesUrlRedux
		{
			get
			{
				return Services.ProgrammesUrlRedux(ReduxItem.service_id, ReduxItem.aired);
			}
		}
		...
		public TimeSpan Duration
		{
			get
			{
				return TimeSpan.FromSeconds(ReduxItem.duration);
			}
		}
		...
		public TimeSpan PipsDuration
		{
			get
			{
				return TimeSpan.FromSeconds(Programme.duration);
			}
		}
